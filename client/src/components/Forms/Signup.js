...
import {
  ...
  FormControl,
  TextField,
  FormHelperText, Hidden, CardMedia,
        ...
        <Grid container justify="center" className={classes.root}>
          ...
          <Grid item xs={12} sm={7}>
            <Box display="flex"
              ...
              <Button onClick={() => history.push("/login")} color="primary" size="large" className={classes.linkButton}>Login</Button>
            </Box>
            <Grid
                container
                direction="column"
            ...
            >
              ...
              <form onSubmit={handleRegister} className={classes.innerForm}>
                <Grid item xs={8} className={classes.gridItemForm}>
                  <Typography align='left' variant="h6"><b>Create an account.</b></Typography>
                </Grid>
                <Grid item xs={8} className={classes.gridItemForm}>
